...
3. Based on the current time, identify which post is coming up next:
   - 11:50 → the noon post
   - 15:50 → the 4-5pm post (also remind to upload today's Reel as a YouTube Short if not done yet)
...
5. For the 15:50 reminder, add a YouTube Shorts reminder if there's a Reel script in today's daily posts:

```
YT SHORT REMINDER — Upload today's Reel to YouTube Shorts
Title, description, and tags are in ~/Downloads/betbro-yt-short.txt
```
