...
| 17 | 2026-04-04 | James | bug | high | new | Cannot find any prop for Mason Fluharty (MLB pitcher) for strikeouts. Player search returns no results. | — |
| 18 | 2026-05-12 | jamccaslen10 | bug | critical | new | "Database error saving new user" on signup screen — user filled out email + password + username (Getbetbro) and hit Create Account on live app (app.getbetbro.com). Account creation fails entirely. Blocking new user acquisition. | — |
